...
summary(AR_1_2_13)
plot(forecast(AR_1_2_13,h=50))
points(1:length(IPA90min_Mon_filtered$Overall),fitted(AR_1_2_13),type="l",col="blue")
tsdisplay(residuals(AR_1_2_13),lag.max=110,main="MA(1,13) Resid. Diagnostics")
