...
```{r}
OLS_Mon<-arima(tseries_90min_Mon_df$Overall,order=c(0,0,0),xreg=tseries_90min_Mon_df$Mon)
tsdisplay(residuals(OLS_Mon),lag.max=25,main="Resid. Diagnostics of OLS")

ARIMA_Mon=auto.arima(tseries_90min_Mon_df$Overall, xreg=tseries_90min_Mon_df$Mon)
ARIMA_Mon
